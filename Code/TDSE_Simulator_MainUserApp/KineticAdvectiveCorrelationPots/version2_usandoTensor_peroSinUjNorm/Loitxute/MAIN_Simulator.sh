...
until [[ $option -eq Out ]]; do
    ...
    read xjmax yjmax
    echo "Write an expression for the B_j(x) integrals as a function of x, y and j"
    read trash
    read Bx
    echo "Write an expression for the B_j(y) integrals as a function of x, y and j"
    read trash
    read By
    echo "Give the coefficients a, b you want to use in each of the dimensions as: a_x b_x a_y b_y"
    read trash
    read a_x b_x a_y b_y
